...
gridParamLogisticRegression = { 
    ...
    'LOGREG__max_iter': [500, 1000, 2000],  # Maksimum iterasyon sayısı artırıldı
}
...
gridParamGradientBoosting = { 
    ...
    'GRADBOOSTING__max_depth': [3, 5],    
    'GRADBOOSTING__subsample': [0.8, 1.0],     
    'GRADBOOSTING__min_samples_split': [2, 5], 
    'GRADBOOSTING__min_samples_leaf': [1], 
    'GRADBOOSTING__max_features': ['sqrt'],  
}
